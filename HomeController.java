...
//        String projectUrl = "http://localhost:8080/redirect";
...
public class HomeController {
    ...
    public static final String INPUT_FILE2 = "EmployeeFile2.xlsx";
//    public static final String INPUT_FILE2 = "C://Users//Public//SkillCheckerFolder//EmployeeFile2.xlsx";
...
//                        temp.concat(cell.getStringCellValue());
    ...
    public static void addRowsToNewSheet(ArrayList<Integer> arr, String skill, String level) throws IOException {
        ...
        String outputFilePath = "C:/Users/Public/SkillCheckerFolder/output_" + skill + "_" + level + ".xlsx";;
